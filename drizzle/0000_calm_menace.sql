...
CREATE TYPE "public"."attendee_type" AS ENUM('named_guest', 'plus_one', 'child');--> statement-breakpoint
CREATE TYPE "public"."event_key" AS ENUM('event_1', 'event_2');--> statement-breakpoint
...
CREATE TABLE "invitation_events" (
	"invitation_id" uuid NOT NULL,
	"event_key" "event_key" NOT NULL,
	"plus_one_allowed" boolean DEFAULT false NOT NULL,
	"children_allowed" boolean DEFAULT false NOT NULL,
	"max_children" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "invitation_events_pk" PRIMARY KEY("invitation_id","event_key")
);
--> statement-breakpoint
...
CREATE INDEX "recovery_requests_ip_idx" ON "recovery_requests" USING btree ("ip_address");--> statement-breakpoint
CREATE UNIQUE INDEX "rsvps_invitation_event_idx" ON "rsvps" USING btree ("invitation_id","event_key");