const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/event-checkboxes-UlLEVVxJ.js","assets/jsx-runtime-CmNvG13l.js","assets/admin-rsvp-harness-BlcWx0Q0.js","assets/guest-rsvp-fields-Cy3zQkMK.js","assets/locale-context-VveYLVII.js","assets/language-switcher-harness-C4PTON7G.js"])))=>i.map(i=>d[i]);
...
const _Users_aeneas_workspace_js_wedding_tests_ct_fixtures_event_checkboxes_EventCheckboxes = () => __vitePreload(() => import('./event-checkboxes-UlLEVVxJ.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.EventCheckboxes);
const _Users_aeneas_workspace_js_wedding_tests_ct_fixtures_admin_rsvp_harness_AdminRsvpHarness = () => __vitePreload(() => import('./admin-rsvp-harness-BlcWx0Q0.js'),true              ?__vite__mapDeps([2,1,3,4]):void 0).then((mod) => mod.AdminRsvpHarness);
const _Users_aeneas_workspace_js_wedding_tests_ct___src_components_guest_rsvp_fields_GuestRsvpFields = () => __vitePreload(() => import('./guest-rsvp-fields-Cy3zQkMK.js'),true              ?__vite__mapDeps([3,1,4]):void 0).then((mod) => mod.GuestRsvpFields);
const _Users_aeneas_workspace_js_wedding_tests_ct_fixtures_language_switcher_harness_LanguageSwitcherHarness = () => __vitePreload(() => import('./language-switcher-harness-C4PTON7G.js'),true              ?__vite__mapDeps([5,1,4]):void 0).then((mod) => mod.LanguageSwitcherHarness);
__pwRegistry.initialize({ _Users_aeneas_workspace_js_wedding_tests_ct_fixtures_event_checkboxes_EventCheckboxes,
  _Users_aeneas_workspace_js_wedding_tests_ct_fixtures_admin_rsvp_harness_AdminRsvpHarness,
  _Users_aeneas_workspace_js_wedding_tests_ct___src_components_guest_rsvp_fields_GuestRsvpFields,
  _Users_aeneas_workspace_js_wedding_tests_ct_fixtures_language_switcher_harness_LanguageSwitcherHarness });

export { requireReact as a, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-DULTPS0E.js.map
